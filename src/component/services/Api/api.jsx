...
export const ManagerForgot_password = (
  data,
  setLoginError,
  navigate,
  setLoading
  ...
  axios
    .post(`${url}/manager/sedotp`, { Email: data.Email })
    .then((res) => {
      if (res.data) {
...
export const ResendOtp = (datas) => {
  axios
    .post(`${url}/manager/sedotp`, { Email: datas.Email })
    .then((res) => {
      console.log(res.data);
    })
    .catch((error) => {
...
export const Managerverifyotp = (
  ...
  axios
    .post(`${url}/manager/verifyotp`, { otp: datas.otp, Email: datas.Email })
    .then((res) => {
      if (res.data) {
        setLoading(false);
...
export const ManagerResetPassword = (
  ...
  axios
    .post(`${url}/manager/forgotpassword`, {
...
export const UserDataRegistration = (
  ...
  axios
    .post(`${url}/manager/createmanager`, registrationData)
    .then((res) => {
      if (res.data) {
        navigate("/");
        reset();
...
export const UserCreateSociety = (
  newSociety,
  CloseCreatenewSociety,
  LodData
) => {
  axios
    .post(`${url}/society/createsocieties`, {
...
export const EditProfile = async (form, Fdata) => {
  axios
    .put(`${url}/manager/updatemanger`, form, {
...
export const ImportantNumbersGet = (setContacts, setLoading) => {
  ...
  axios
    .get(
      `${url}/importantnumber/getAllImportantNumbers`
      //  {
      //     headers: {
...
export const ImportantNumbersPost = (newNumber, Fdata, setLoading) => {
  const token = localStorage.getItem("token");
  axios
    .post(`${url}/importantnumber/createImportantNumber`, newNumber, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const ImportantNumbersDelete = (
  _id,
  contacts,
  setContacts,
  ClosedeleteContact,
  ...
  axios
    .delete(`${url}/importantnumber/deleteImportantNumber/${_id}`)
    .then((res) => {
      console.log(res);
...
export const updateImportantNumber = (
  _id,
  editNumber,
  Fdata,
  closeEditModal,
  ...
  axios
    .put(`${url}/importantnumber/updateImportantNumber/${_id}`, editNumber)
    .then(() => {
      closeEditModal();
      Fdata();
      setLoading(false);
...
export const PostSumdata = async (formData) => {
  ...
  try {
    const response = await axios.post(`${url}/resident/create`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    });
...
export const EditComplaint = async (
  ...
  try {
    const res = await axios.put(
      `${url}/complaint/updateComplaint/${_id}`,
      editComplaint
    );
    console.log(res.data);
    closeEditComplint();
...
export const Post_Security_Protocols = (
  data,
  Fdata,
  CloseAddProtocols,
  setloding
...
export const Delete_Security_Protocols = (
  _id,
  setdeleteloding,
...
export const Edit_Delete_Security_Protocols = (
  _id,
  data,
  setloding,
  CloseEditProtocols
...
export const PostGuard_Details = (
  data,
  CloseAddSecurity,
  Fdata,
  setloading
  ...
  setloading(true);
  axios
    .post(`${url}/security/createsecurity`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    })
    .then((res) => {
      CloseAddSecurity();
...
export const DeleteGuard_Details = (
  _id,
  setloadingDelete,
  Guard_Details,
  setGuard_Details,
...
export const EditGuard_Details = (
  _id,
  formData,
  CloseEdit,
  Fdata,
  ...
  setloading(true);
  axios
    .put(`${url}/security/updatesecurity/${_id}`, formData, {
      headers: { "Content-Type": "multipart/form-data" },
    })
    .then((res) => {
      CloseEdit();
...
export const GetAnnouncement = (setgetAnnouncement, setLoding) => {
  axios
    .get(`${url}/announcement/getAllAnnouncements`)
    .then((res) => {
...
export const DeleteAnnouncementDele = (
  _id,
  Fdata,
  ClaseDeleteAnnouncement,
  setloadingDelete
) => {
  setloadingDelete(true);
  axios
    .delete(`${url}/announcement/deleteAnnouncement/${_id}`)
    .then((res) => {
      Fdata();
...
export const EditAnnouncement = (
  ...
  setloading(true);
  axios
    .put(`${url}/announcement/updateAnnouncement/${_id}`, formData)
    .then((res) => {
      ClaseEditAnnouncement();
      setloading(false);
      LodaData();
...
export const Facility_Management_Post = (
  data,
  Fdata,
  setClosecreate_facility,
  setloading
) => {
  setloading(true);
...
export const Facility_Management_Delete = (
  DeleteData,
  DeleteClose,
  setloading,
  incomeData,
...
export const Facility_Management_Edit = (
  _id,
  data,
  setloading,
  seteditcreate_facility,
  lodData
) => {
  setloading(true);
...
export const GetMaintenance = (setudata) => {
  axios.get(`${url}/maintenance/getAllaintenances`).then((res) => {
    ...
    setudata(res.data.maintenances);
  });
};
...
export const UpdateOtherIncome = async (id, data) => {
  try {
    const response = await axios.put(
      `${url}/otherincome/updateOtherincome/${id}`,
      data
    );
...
export const PostExpanse = async (
  data,
  Fdata,
  setAddExpense,
  setPreviewImage,
...
export const PostVisiter = (data, Fdata, setAddVisiterbox) => {
  axios
    .post("https://sms-backend-blue.vercel.app/Visitors", data)
    .then((res) => {
      Fdata();
...
export const PendingMaintenancesmembers = (PendingMaintenancesmembers) => {
  axios.get(`${url}/maintenance/pending-maintenance`).then((res) => {
    console.log(res.data);
    PendingMaintenancesmembers(res.data);
  });
};
